...
function loadWidget(waifuPath, apiPath) {
	...
	function loadModel(modelId, modelTexturesId) {
		...
		//loadlive2d('live2d', 'localhost/live2d/get/?id='+modelId+'-'+modelTexturesId, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
	...
	function loadRandModel() {
		...
		$.ajax({
			cache: false,
			//url: 'localhost/live2d/'+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
	...
	function loadOtherModel() {
		...
		$.ajax({
			cache: false,
			//url: 'localhost/live2d/'+modelTexturesRandMode+'/?id='+modelId,
